...
# The text recommended removing the observations (subMac[2]) out of the analysis; "00:0f:a3:39:dd:cd".
...
# RMSE for Analysis(using full training model, incorporation optimal parameter values)  'CalcErrorOptimal'
...
#pdf(file=paste("Fig 1.11 Geo_ScatterSignalDist_MacRemoved_",mr,'_weighted_',DisWeighted,'.pdf'), width = 7, height = 10)
win.metafile(file=paste("Fig 1.11 Geo_ScatterSignalDist_MacRemoved_",mr,'.wmf'), width = 7, height = 10)
...
length(unique(online$posXY)) # 60 unique test positions [Note: 60 posX; 53 posY] (Book Base Case)
...
#-----
        ...
        # #pdf(file=paste("Fig 1.12A GEO_FloorPlan_K3_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 7)
        # win.metafile(file=paste("Fig 1.12A GEO_FloorPlan_K3_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 7)
        # 
        ...
        # #pdf(file=paste("Fig 1.12B GEO_FloorPlan_K1_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 7)
        # win.metafile(file=paste("Fig 1.12B GEO_FloorPlan_K1_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".wmf"), width = 10, height = 7)
        # 
        # oldPar = par(mar = c(1, 1, 1, 1))
        ...
        # #pdf(file=paste("Fig 1.12C GEO_FloorPlan_K5_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 7)
        # win.metafile(file=paste("Fig 1.12C GEO_FloorPlan_K5_Errors_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".wmf"), width = 10, height = 7)
        # 
        # oldPar = par(mar = c(1, 1, 1, 1))
        # floorErrorMap(estXYk1, onlineSummary[ , c("posX","posY")], 
        #               trainPoints = trainPoints, AP = AP)
...
#offlineMacRemoved = offline[ offline$mac != subMacs[as.integer(mr)], ] #reduced to 769332 obs
...
#pdf(file = paste("Fig 1.13 Geo_CVChoiceOfK_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 6)
win.metafile(file = paste("Fig 1.13 Geo_CVChoiceOfK_",val,"MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".wmf"), width = 10, height = 6)
...
# Rerun prediction model using full training set, incorporation optimal parameters (# of Nearest Neighbors)
...
# Using optimal KNN = val, Number of traning dataset angles = per model, Weighted Distance = per model, MacID removed = per model 
#pdf(file=paste("Fig 1.12 GEO_FloorPlan_Errors_K_",val,"_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".pdf"), width = 10, height = 7)
win.metafile(file=paste("Fig 1.12 GEO_FloorPlan_Errors_K_",val,"_MacRemoved_",mr,'_weighted_',DisWeighted,'_SigAngles_',Angles,".wmf"), width = 10, height = 7)
...
# Write Summary CSVs
Summary <- Summary[-1,]
row.names(Summary) <- c('SM0_WT_SA1','SM0_WF_SA1','SM0_WT_SA2','SM0_WF_SA2','SM0_WT_SA3','SM0_WF_SA3','SM0_WT_SA4','SM0_WF_SA4',
                       'SM1_WT_SA1','SM1_WF_SA1','SM1_WT_SA2','SM1_WF_SA2','SM1_WT_SA3','SM1_WF_SA3','SM1_WT_SA4','SM1_WF_SA4',
                       'SM2_WT_SA1','SM2_WF_SA1','SM2_WT_SA2','SM2_WF_SA2','SM2_WT_SA3','SM2_WF_SA3','SM2_WT_SA4','SM2_WF_SA4')
colnames(Summary) <- c('MacID_Elim','Wt_Dist','Num_Sig_Angles','Opt_Near_Neig','RMSE_CV_Model','RMSE_Full_Model','RMSE_All_Vals_kNN')
