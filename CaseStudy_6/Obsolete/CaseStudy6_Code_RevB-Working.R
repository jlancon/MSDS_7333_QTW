...
c('#1','100%','100% free','100% satisfied','50% off','Ad','All New','Bargain','Best Price','Bonus','Brand New',
  'Pager','Claims not to be selling anything','Cost','Costs','Credit','Discount','Email harvest',
  ...
  'Great offer','Incredible deal','Insurance','Internet market','Internet marketing',
  ...
  'Form','Free access','Free instant','Full refund','Investment','Investment decision','Life',
  ...
  'Take action','Tack action now','Terms and conditions','The following form',
  'Trial','Trial unlimited','Unlimited','Unlimited trial','What are you waiting for?',
  'Nl1Unsubscribe','Visit our website','Act Now','Act Now!','Action','Apply now','Apply online','Buy',
  'Buy Direct','Buying judgements','Call','Call free','Call now','Clearance',
  ...
  'Time limited','Urgent','While supplies last','4u','Acceptance','Access','Avoid Bankruptcy',
  ...
  'Win','Winner','Winning','Won','You are a winner!','You have been selected!',
  ...
  'Vacation','Vacation offers','Weekend getaway','Weight','Weight loss',
  ...
  'They try to keep your money, no refund','Undisclosed recipient',
