...
results_boston.columns=['PercentImputed','RSquared','AdjRSquared','BIC','MSE','Model']

print(results_boston) # Prints results of analysis for each percent of Imputed variables

# Plot of R2 values analysis results vs different Percentage of Imputation
results_boston.RSquared.plot()

# Plot of MSE values analysis results vs different Percentage of Imputation
results_boston.MSE.plot()
